...
export interface GridTileProps {
  ...
  /**
   * Whether this tile shows the expand control. Defaults to `true` (the normal
   * Workspace grid). The collected view passes `false` (via Grid) so its bays
   * omit the per-tile expand-to-fill action.
   */
  showExpand?: boolean;
}
